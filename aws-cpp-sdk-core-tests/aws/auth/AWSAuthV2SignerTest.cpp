...
static Standard::StandardHttpRequest ParseHttpRequest(Aws::IOStream& inputStream)
{
...
static Aws::String MakeSigV2ResourceFilePath(const Aws::String& testName, const Aws::String& fileSuffix)
{
...
static void RunV2TestCase(const char* testCaseName)
{
    ...
    Aws::String expectedSignatureFileName = MakeSigV2ResourceFilePath(testCaseName, "authz");
...
TEST(AWSAuthV2SignerTest, GetVanilla)
{
    RunV2TestCase("get-vanilla");
}

TEST(AWSAuthV2SignerTest, GetQueryString)
{
...
TEST(AWSAuthV2SignerTest, GetNonXAMZ)
{
    RunV2TestCase("get-non-x-amz");
}

TEST(AWSAuthV2SignerTest, GetContentType)
{
    RunV2TestCase("get-content-type");
}

TEST(AWSAuthV2SignerTest, GetContentMD5)
{
    RunV2TestCase("get-content-md5");
}

TEST(AWSAuthV2SignerTest, GetContentBoth)
{
    RunV2TestCase("get-content-both");
}
